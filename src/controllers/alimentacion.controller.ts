...
import { AlimentacionService, ServiceError } from '../services/alimentacion.service';

export class AlimentacionController {
  private service = new AlimentacionService();

  list = async (req: Request, res: Response) => {
    const animalId = req.query.animal_id ? Number(req.query.animal_id) : undefined;
    res.json(await this.service.listAll(animalId));
  };
