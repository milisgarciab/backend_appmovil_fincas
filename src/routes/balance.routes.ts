 ...
 * /balance/resumen:
 *   get:
 *     summary: Balance rápido en vivo, sin guardar (HU-33)
 *     tags: [Financiera]
 *     security: [{ bearerAuth: [] }]
 *     parameters:
 *       - in: query
 *         name: rango
 *         schema: { type: string, enum: [hoy, semana, mes] }
 *     responses:
 *       200: { description: Balance en vivo del rango solicitado }
 */
router.get('/resumen', controller.resumenRapido);
